...
# (All other functions before get_papers are unchanged and correct)
...
# --- REWRITTEN: The /api/papers route now includes the upload_date ---
...
def get_papers():
    ...
    # The search logic itself is unchanged and correct
    if not search_query:
    ...
    for row in papers_rows:
        ...
        # The upload_date is now included in the data sent to the front-end
